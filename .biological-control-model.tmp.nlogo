...
to setup
  ...
  ;set length-simulation (nb-years * (length-season + 1))
...
to go
  ...
  ;;; Period 2: convert juveniles into adults + update crop loss + flee
  ...
  [
    ...
    ; kill juveniles and adults in crops
  ...
  if ticks >= (length-simulation - 1) [stop]
end
@#$#@#$#@
GRAPHICS-WINDOW
658
